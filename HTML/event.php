...
<body>
    <div class="container">
        <div class="applybox">
            ...
            <form action="main6.php" method="POST" enctype="multipart/form-data">
...
<select name="Category" id="category" required>
 ...
 <div class="formcontrol">
  ...
  <input value=""
  id="Runners" name="Runners" placeholder="" type="text" required>
 </div>
 <div class="formcontrol">
  <label for="Organizers">Organizers</label>
  <input value=""
  id="Organizers" name="Organizers" placeholder="" type="text" required>
 </div>
 <div class="formcontrol">
