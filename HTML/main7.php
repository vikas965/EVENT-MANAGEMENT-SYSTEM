<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET')
    {
        ...
        $sql = "UPDATE `eventdetails` set  (`content`,`phoster`,`date`,`time`,`mode`,`venue`,`catagiry`,`speakerinfo`,`winner`,`runnner`,`organiser`,`prize`) VALUES
         ('$content','$filedstination','$date','$time','$mode','$venue','$Category','$speakerinfo','$winner','$runner','$orga','$prize' WHERE sr-no = $id )";
